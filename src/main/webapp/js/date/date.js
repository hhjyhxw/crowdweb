...
(function ($) {      
	...
	function resetIndex(){
        ...
        function resetInitDete(){
            ...
            initY = parseInt(that.val()) - beginyearTemp; //20150522xie改
              ...
              yearScroll = new iScroll("yearwrapper",{snap:"li",vScrollbar:false,
                  onScrollEnd:function () {
                      ...
                      //opts.endday = checkdays(strY,strM);
                       opts.endday = checkdays(indexY + beginyearTemp - 1, indexM);//20150522xie改
