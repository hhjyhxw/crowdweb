...
<body>
<form action="${pageContext.request.contextPath}/raise/raiseUpdateDo" method="post" name="form1" id="form1" onsubmit="return onSubmitAction();" enctype="multipart/form-data">
    ...
    <td background="${pageContext.request.contextPath}/images/wsoa_window_002.gif">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
		  <tr>
			...
			<td align="left" background="${pageContext.request.contextPath}/images/wsoa_window_002.gif"><span class="tfont12"><label id="functiontitle"><strong>修改众筹活动</strong> </label></td>
					...
					<table border="0" style="width:100%" align="center" class="table5">
						...
						<!-- 
							<tr>
								...
								<td align="left" class="table5" colspan="2">&nbsp;<input name="totalShare" class="input" id="_totalShare"  style="width:50%" value="${raise.totalShare}" /></td>
							</tr>						
						 -->
						 <input type="hidden" name="totalShare" class="input" id="_totalShare"  style="width:50%" value="${raise.totalShare}" />
						<tr>
						...
						<tr>
							...
							<td align="left" class="table5" colspan="2">
								<select name="deliveryType" class="input" id="_deliveryType"  style="width:50.3%;margin-left:4px;">
									...
									<option value="" <c:if test="${empty raise.deliveryType}">selected="selected"</c:if>></option>
								</select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="left" class="table5" colspan="2" id="_productDetailsTR">
						    <!-- 加载编辑器的容器 -->
			...
			<td><table  border="0" style="width:100%">			 		
				<tr>
					<td height="30" align="center" valign="bottom">
						<input type="hidden" name="id" id="_raiseIcon" value="${raise.id}"/>
						<input type="submit" value="更新(u)"class="button_03"  />
						&nbsp;	
